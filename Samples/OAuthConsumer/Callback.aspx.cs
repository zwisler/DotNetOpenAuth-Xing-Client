namespace OAuthTest
{
    ...
    public partial class Callback : System.Web.UI.Page
    {
        ...
        private const string clientId = "00000000440CA7ED";

        // Make sure this is identical to the redirect_uri parameter passed in WL.init() call.
        private const string callback = "/callback.aspx";
        private const string clientSecret = "idcfdDF-OyekqpCqEMKmepMdtQ1EqwRp";
