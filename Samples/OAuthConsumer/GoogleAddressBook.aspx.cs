namespace OAuthConsumer {
	...
	public partial class GoogleAddressBook : System.Web.UI.Page {
		...
		protected void getAddressBookButton_Click(object sender, EventArgs e) {
			...
			XDocument contactsDocument = GoogleConsumer.GetContacts(google, this.AccessToken, 100, 1);
			var contacts = from entry in contactsDocument.Root.Elements(XName.Get("entry", "http://www.w3.org/2005/Atom"))
                           where entry.Element(XName.Get("email", "http://schemas.google.com/g/2005")) != null
						   select new
                           {
